...
datDIR <- data[ QCF_DIR == "good" & !is.na(wattDIR) ]
data   <- datDIR
...
for (av in c(wecare, "relN")) {
    ...
    print(
        levelplot(mtx,
                  ...
                  main = paste("Beam Irradiance asymetry:", av),
                  col.regions = Ocols,
                  at = brk,
                  panel=function(...) {
                      arg <- list(...)
...
print(
    levelplot(mtx,
              ...
              xlab = "Declination from South",
              ylab.right = "West                                 East",
              main = paste("Beam Irradiance asymetry:", av, "p <", p_lim, "relN <", rel_lim ),
              col.regions = Ocols,
              at = brk,
              panel=function(...) {
                  arg <- list(...)
...
for (im in 1:12) {
    ...
    print(
        levelplot(mtx,
                  ...
                  xlab = "Declination from South",
                  ylab.right = "West                                 East",
                  main = paste("Beam Irradiance asymetry:", av, "Month:",im),
                  col.regions = Ocols,
                  at = brk,
                  panel=function(...) {
                      arg <- list(...)
...
#                   xlab = "Declination from South",
#                   ylab.right = "West                                 East",
#                   main = paste("Beam Irradiance Ratio:", av),
#                   col.regions = Ocols,
#                   at = brk,
#                   panel=function(...) {
#                       arg <- list(...)
