...
Monitoring downward shortwave solar irradiance or Global Horizontal Irradiance (GHI) has multiple importance for different fields. It can provide information for the energy balance of the atmosphere and the world climate, the agricultural production, and energy production and usage, among others. Already, there are observations describing the positive trends of GHI for the last decades, with the major mechanisms of this drive, changes in Aerosols consecration and clouds interaction. In this study we use time series of GHI measurements by a CM21 pyranometer of the Laboratory of Atmospheric Physics in Thessaloniki, to investigate the trends for the period 1993-2021.
