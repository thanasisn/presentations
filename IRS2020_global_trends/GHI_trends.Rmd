...
The monitoring of GHI has multiple importance for different fields. It can provide information for the energy balance of the atmosphere and world climate, the agricultural production, energy production and usage, among other. Already there are observation describing positive trends of GHI for the last decades, with the major mechanisms this drive changes in Aerosols consecration and clouds interaction.
...
These results are in accordance with other studies [@Wild2012; @Wild2009; @Philipona2009; @Kazadzis2007], that have linked the increasing of the observed downward shortwave solar irradiance. The two main factors that may affect the brightening over the site is the reduction of the Aerosols in the atmosphere, and the encasement of the GHI by the clouds.......cite.......

Some interesting questions resulting from this work, is how strong is the effect of the Aerosols cleaning and the attenuation by the clouds. And, the dependency on the annual cycle and the solar zenith angel. Also, if we will be able to discern long term changes on a diurnal level over Thessaloniki.
