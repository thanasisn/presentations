...
For both conditions there is positive increasing trend in the GHI over the last decades. For all sky condition we observe an an increase of $+0.44\%\cdot\text{year}^{-1}$ (Figure \@ref(fig:alltrend)) and for clear sky conditions increase of $+0.38\%\cdot\text{year}^{-1}$ (Figure \@ref(fig:cleartrend)) Those results indicate that there is some long-term changes on the conditions over Thessaloniki.
...
[@Wild2012; @Wild2009; @Philipona2009; @Kazadzis2007]
